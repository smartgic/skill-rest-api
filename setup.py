...
URL = "https://github.com/smartgic/skill-rest-api"
SKILL_CLAZZ = "RestApiSkill"
PYPI_NAME = "skill-rest-api"
...
BASE_PATH = BASE_PATH = path.abspath(
    path.join(path.dirname(__file__), "skill_rest_api")
)
...
setup(
    ...
    license="MIT",
    package_dir={SKILL_PKG: "skill_rest_api"},
